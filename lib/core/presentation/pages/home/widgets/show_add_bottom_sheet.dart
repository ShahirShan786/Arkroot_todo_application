...
// First, create a provider for managing the selected date
...
// Updated showAddBottomSheet function
...
void showAddBottomSheet(BuildContext context, WidgetRef ref) {
  ...
  // Reset the selected date when opening the bottom sheet
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                buildTaskInputField(titleController, descriptionController, ref),
